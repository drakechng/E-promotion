            ...
            <aside className="main-sidebar">
              ...
              <i className="fa fa-angle-left pull-right"></i>
                            ...
                            <ul className="treeview-menu">
                                ...
                                <li><NavLink to="/estamps"> <i className="fa fa-circle-o"></i>E-Stamp System</NavLink>
                                </li>
              ...
              <i className="fa fa-angle-left pull-right"></i>
                            ...
                            <ul className="treeview-menu">
                                <li><NavLink to="/manage-vouchers"> <i className="fa fa-circle-o"></i>Vouchers</NavLink>
                                </li>
                                <li><NavLink to="/manage-estamps"> <i className="fa fa-circle-o"></i>E-Stamps</NavLink>
                                </li>
                                <li><NavLink to="/members"> <i className="fa fa-circle-o"></i>Members</NavLink></li>
                                <li><NavLink to="/addmember"> <i className="fa fa-circle-o"></i>All Customers</NavLink>
                                </li>
