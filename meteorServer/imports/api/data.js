...
const data = {
  menus: [
        ...
        { text: 'Editor', icon: <PermIdentity />, link: '/eventCreate' },
        { text: 'Add Members', icon: <Web />, link: '/addmembers' },
        { text: 'Members List', icon: <GridOn />, link: '/membersList' },
        { text: 'Event', icon: <PermIdentity />, link: '/eventsList' },
