...
class SettingsPage extends React.Component {
  ...
  render() {
    ...
    const imageUrl = this.props.settings.photo ? this.props.settings.photo.getFileRecord().url() : 'default_profile.png';
...
title="Settings"
        ...
        <form onSubmit={this.handleSubmit}>
          ...
          <SelectField
floatingLabelText="City" onChange={this.onSelectChanged} value={this.state.selectValue}
                                 fullWidth={true}>
